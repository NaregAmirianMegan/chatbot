...
def compile_data(test_size, train_size, database):
    ...
    test_text = open("compiled_data/{}.test.text".format(database), "a")
    test_reply = open("compiled_data/{}.test.reply".format(database), "a")
    train_text = open("compiled_data/{}.train.text".format(database), "a")
    train_reply = open("compiled_data/{}.train.reply".format(database), "a")
...
if __name__ == '__main__':
    compile_data(10, 100, 'RC_2018-01')
